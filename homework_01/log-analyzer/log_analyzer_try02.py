...
class ConfigLocal:
    ...
    APP_CONFIG_DEFAULT_PATH: str = "./resources/config.json"  # Стандартный путь расположения config
    APP_FILE_LAST_EFFECTIVE_START: str = "./resources/last_effective_start.json"  # Информация о последнем запуске программы
